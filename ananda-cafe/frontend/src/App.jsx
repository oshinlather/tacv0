  ...
  return (
    <div id="print-kitchen">
      ...
      <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #E8E8E4", marginBottom: 20 }}>
        <div style={{ padding: "14px 18px", borderBottom: "1px solid #E8E8E4", fontWeight: 700, fontSize: 14, position: "sticky", top: 96, background: "#fff", zIndex: 8, borderRadius: "14px 14px 0 0" }}>📋 Consolidated Demand</div>
        <div style={{ overflowX: "auto" }}><table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12.5 }}><thead><tr>{["Item", "TOTAL", ...OUTLETS.map((o) => o.short)].map((h, i) => <th key={i} style={{ ...thS, textAlign: i > 0 ? "center" : "left", color: i === 1 ? "#1A1A1A" : undefined, fontWeight: i === 1 ? 800 : undefined, whiteSpace: "nowrap", minWidth: i === 0 ? 90 : 50, position: "sticky", top: 140, background: "#FAFAF8", zIndex: i === 0 ? 7 : 5, ...(i === 0 ? { left: 0 } : {}) }}>{h}</th>)}</tr></thead>
