...
const DEMAND_SECTIONS = [
  ...
  { id: "dairy", titleHi: "Dairy", emoji: "🥛", color: "#2563EB", bg: "#EFF6FF", border: "#BFDBFE",
    items: [
      { id: "butter", name: "Butter", unit: "Gm" },
      { id: "cheese", name: "Cheese", unit: "Gm" },
      { id: "paneer", name: "Paneer", unit: "Gm" },
      { id: "amul_cream", name: "Amul Cream", unit: "Gm" },
  ...
  { id: "grocery", titleHi: "Grocery & Staples", emoji: "🛒", color: "#EA580C", bg: "#FFF7ED", border: "#FED7AA",
    items: [
      ...
      { id: "kaju", name: "Kaju (Cashew)", unit: "Gm" },
