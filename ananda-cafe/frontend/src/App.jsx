...
const DEMAND_SECTIONS = [
  { id: "food", titleHi: "Food (Prepared in BK)", emoji: "🍲", color: "#B45309", bg: "#FFFBEB", border: "#FDE68A",
    items: [
      { id: "coconut_crush", name: "Coconut Crush", unit: "Kg" }, { id: "dosa_batter", name: "Dosa Batter", unit: "Kg" },
      { id: "garlic_paste", name: "Garlic Paste", unit: "Kg" }, { id: "idli_batter", name: "Idli Batter", unit: "Kg" },
      { id: "onion_masala", name: "Onion Masala", unit: "Kg" }, { id: "pineapple_halwa", name: "Pineapple Halwa", unit: "Kg" },
      { id: "podi_masala", name: "Podi Masala", unit: "Kg" }, { id: "rasam", name: "Rasam", unit: "Ltr" },
      { id: "rawa_mix", name: "Rawa Mix", unit: "Kg" }, { id: "red_chutney", name: "Red Chutney", unit: "Kg" },
      { id: "roasted_karipatta", name: "Roasted Karipatta", unit: "Kg" }, { id: "roasted_peanuts", name: "Roasted Peanuts", unit: "Kg" },
      { id: "sambhar", name: "Sambhar", unit: "Ltr" }, { id: "sevya_payasam", name: "Sevya Payasam", unit: "Kg" },
      { id: "tadka", name: "Tadka", unit: "Ltr" }, { id: "vada_batter", name: "Vada Batter", unit: "Kg" },
      { id: "white_chutney", name: "White Chutney", unit: "Kg" },
    ]},
  { id: "vegetable", titleHi: "Vegetables", emoji: "🥬", color: "#16A34A", bg: "#F0FDF4", border: "#BBF7D0",
    items: [
      { id: "anar", name: "Anar", unit: "Pcs" }, { id: "curry_leaves", name: "Curry Leaves", unit: "Kg" },
      { id: "green_chillies", name: "Green Chillies", unit: "Kg" }, { id: "lemon", name: "Lemon", unit: "Kg" },
      { id: "garlic", name: "Garlic", unit: "Kg" }, { id: "beans", name: "Beans", unit: "Kg" },
      { id: "ginger", name: "Ginger", unit: "Kg" }, { id: "mint", name: "Mint (Pudina)", unit: "Kg" },
      { id: "potato", name: "Potato", unit: "Kg" }, { id: "coconut", name: "Coconut", unit: "Pcs" },
      { id: "coriander_leaves", name: "Coriander Leaves", unit: "Kg" }, { id: "carrot", name: "Carrot", unit: "Kg" },
      { id: "petha", name: "Petha", unit: "Kg" }, { id: "staff_veg", name: "Staff Veg", unit: "Kg" },
      { id: "tomatoes", name: "Tomatoes", unit: "Kg" }, { id: "onions", name: "Onions", unit: "Kg" },
      { id: "drumstick", name: "Drumstick", unit: "Kg" }, { id: "banana_leaves", name: "Banana Leaves", unit: "Pcs" },
      { id: "pineapple", name: "Pineapple", unit: "Pcs" },
    ]},
  { id: "grocery", titleHi: "Grocery", emoji: "🛒", color: "#DC2626", bg: "#FEF2F2", border: "#FECACA",
    items: [
      { id: "kitchen_king", name: "Kitchen King", unit: "Pkt" }, { id: "kesar", name: "Kesar", unit: "Gm" },
      { id: "ilaychi", name: "Ilaychi", unit: "Kg" }, { id: "hing_powder", name: "Hing Powder", unit: "Pkt" },
      { id: "deggi_mirch", name: "Deggi Mirch", unit: "Pkt" }, { id: "kali_mirch", name: "Kali Mirch", unit: "Kg" },
      { id: "kaju", name: "Kaju", unit: "Kg" }, { id: "desi_ghee", name: "Desi Ghee", unit: "Tin" },
      { id: "kishmish", name: "Kishmish", unit: "Kg" }, { id: "whole_red_chilli", name: "Whole Red Chilli", unit: "Kg" },
      { id: "haldi_powder", name: "Haldi Powder", unit: "Kg" }, { id: "safed_til", name: "Safed Til", unit: "Kg" },
      { id: "chai_patti", name: "Chai Patti", unit: "Kg" }, { id: "fortune_refined", name: "Fortune Refined Oil", unit: "Tin" },
      { id: "dhaniya_whole", name: "Dhaniya Whole", unit: "Kg" }, { id: "imli", name: "Imli", unit: "Kg" },
      { id: "rajma", name: "Rajma", unit: "Kg" }, { id: "urad_daal_whole", name: "Urad Daal Whole", unit: "Kg" },
      { id: "chhole", name: "Chhole", unit: "Kg" }, { id: "staff_dal", name: "Staff Dal", unit: "Kg" },
      { id: "methi_dana", name: "Methi Dana", unit: "Kg" }, { id: "mustard_seeds", name: "Mustard Seeds", unit: "Kg" },
      { id: "semiyan", name: "Semiyan", unit: "Kg" }, { id: "besan", name: "Besan", unit: "Kg" },
      { id: "poha", name: "Poha", unit: "Kg" }, { id: "amchoor_powder", name: "Amchoor Powder", unit: "Kg" },
      { id: "chana_dal", name: "Chana Dal", unit: "Kg" }, { id: "rice_powder", name: "Rice Powder", unit: "Kg" },
      { id: "upma_sooji", name: "Upma Sooji", unit: "Kg" }, { id: "meetha_soda", name: "Meetha Soda", unit: "Kg" },
      { id: "gur", name: "Gur", unit: "Kg" }, { id: "sugar", name: "Sugar", unit: "Kg" },
      { id: "atta", name: "Atta", unit: "Kg" }, { id: "salt", name: "Salt", unit: "Kg" },
      { id: "garam_masala", name: "Garam Masala", unit: "Pkt" }, { id: "achar", name: "Achar", unit: "Kg" },
      { id: "dhaniya_powder", name: "Dhaniya Powder", unit: "Kg" }, { id: "filter_coffee_powder", name: "Filter Coffee Powder", unit: "Pkt" },
      { id: "papad_777", name: "777 Papad", unit: "Pkt" }, { id: "sambhar_masala_777", name: "Sambhar Masala 777", unit: "Kg" },
      { id: "red_chilli_powder", name: "Red Chilli Powder", unit: "Kg" }, { id: "chat_masala", name: "Chat Masala", unit: "Pkt" },
      { id: "long", name: "Long", unit: "Kg" }, { id: "sarson_tel", name: "Sarson Tel", unit: "Ltr" },
      { id: "arhar_dal", name: "Arhar Dal", unit: "Kg" }, { id: "pista", name: "Pista", unit: "Kg" },
      { id: "almond", name: "Almond", unit: "Kg" }, { id: "soya_badi", name: "Soya Badi", unit: "Kg" },
      { id: "jeera", name: "Jeera", unit: "Kg" }, { id: "peanuts", name: "Peanuts", unit: "Kg" },
      { id: "roasted_chana", name: "Roasted Chana", unit: "Kg" }, { id: "golden_sela_rice", name: "Golden Sela Rice", unit: "Kg" },
      { id: "sona_masoori_rice", name: "Sona Masoori Rice", unit: "Kg" }, { id: "black_salt", name: "Black Salt", unit: "Kg" },
      { id: "kasturi_methi", name: "Kasturi Methi", unit: "Kg" }, { id: "water", name: "Water", unit: "Ltr" },
      { id: "milk", name: "Milk", unit: "Ltr" }, { id: "milkmaid", name: "Milkmaid", unit: "Kg" },
    ]},
  { id: "packaging", titleHi: "Packaging", emoji: "📦", color: "#2563EB", bg: "#EFF6FF", border: "#BFDBFE",
    items: [
      { id: "biopoly_16x20", name: "16x20 Biopolythene", unit: "Pkt" }, { id: "bio_garbage_bag", name: "Bio Garbage Bag", unit: "Pkt" },
      { id: "bio_spoon", name: "Bio Spoon", unit: "Pkt" }, { id: "butter_paper", name: "Butter Paper", unit: "Pkt" },
      { id: "chef_cap", name: "Chef Cap", unit: "Pkt" }, { id: "clean_wrap", name: "Clean Wrap", unit: "Pcs" },
      { id: "dosa_box_big", name: "Dosa Box Big", unit: "Pkt" }, { id: "dosa_box_small", name: "Dosa Box Small", unit: "Pkt" },
      { id: "filter_coffee_glass", name: "Filter Coffee Glass", unit: "Pkt" }, { id: "filter_coffee_pkg", name: "Filter Coffee Packaging", unit: "Pkt" },
      { id: "hand_gloves", name: "Hand Gloves", unit: "Pkt" }, { id: "kitchen_wipes", name: "Kitchen Wipes", unit: "Pkt" },
      { id: "chhachh_glass", name: "Masala Chhachh Glass", unit: "Pkt" }, { id: "chhachh_pkg", name: "Masala Chhachh Packaging", unit: "Pkt" },
      { id: "paper_bowl", name: "Paper Bowl", unit: "Pkt" }, { id: "podi_idli_container", name: "Podi Idli Container", unit: "Pkt" },
      { id: "printer_roll", name: "Printer Roll", unit: "Pcs" }, { id: "silver_container", name: "Silver Container", unit: "Pkt" },
      { id: "stirrer", name: "Stirrer", unit: "Pkt" }, { id: "tape", name: "Pcs" },
      { id: "tissues", name: "Tissues", unit: "Pkt" }, { id: "vada_lifafa", name: "Vada Lifafa", unit: "Pkt" },
      { id: "wooden_plates", name: "Wooden Plates", unit: "Pkt" }, { id: "container_100ml", name: "100ML Container", unit: "Pkt" },
      { id: "container_50ml", name: "50ML Container", unit: "Pkt" }, { id: "container_250ml", name: "250ML Container", unit: "Pkt" },
      { id: "container_300ml", name: "300ML Container", unit: "Pkt" }, { id: "container_500ml", name: "500ML Container", unit: "Pkt" },
      { id: "rasam_glass", name: "Rasam Glass", unit: "Pkt" }, { id: "biopoly_13x16", name: "13x16 Biopolythene", unit: "Pkt" },
    ]},
  { id: "cleaning", titleHi: "Cleaning", emoji: "🧹", color: "#9333EA", bg: "#FAF5FF", border: "#E9D5FF",
    items: [
      { id: "bartan_sabun", name: "Bartan Sabun", unit: "Pcs" }, { id: "pochha", name: "Pochha", unit: "Pcs" },
      { id: "sarf", name: "Sarf", unit: "Pkt" }, { id: "fool_jhadu", name: "Fool Jhadu", unit: "Pcs" },
      { id: "duster", name: "Duster", unit: "Pcs" }, { id: "seek_jhadu", name: "Seek Jhadu", unit: "Pcs" },
      { id: "wiper", name: "Wiper", unit: "Pcs" }, { id: "phenyl", name: "Phenyl", unit: "Ltr" },
      { id: "sanitizer", name: "Sanitizer", unit: "Ltr" }, { id: "steel_juna", name: "Steel Juna", unit: "Pcs" },
