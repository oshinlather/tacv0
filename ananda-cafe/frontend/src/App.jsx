...
const DEMAND_SECTIONS = [
  ...
  { id: "packaging", titleHi: "Packaging & Disposal", emoji: "📦", color: "#2563EB", bg: "#EFF6FF", border: "#BFDBFE",
    items: [
      { id: "container_50ml", name: "50ML Container", unit: "Pcs" },
      { id: "container_100ml", name: "100ML Container", unit: "Pcs" },
      { id: "container_250ml", name: "250ML Container", unit: "Pcs" },
      { id: "container_300ml", name: "300ML Container", unit: "Pcs" },
      { id: "container_500ml", name: "500ML Container", unit: "Pcs" },
      { id: "podi_idli_container", name: "Podi Idli Container", unit: "Pcs" },
      { id: "silver_container", name: "Silver Container", unit: "Pcs" },
      ...
      { id: "biopoly_16x20", name: "16*20 Biopolythene", unit: "Pcs" },
      { id: "biopoly_13x16", name: "13*16 Biopolythene", unit: "Pcs" },
      { id: "bio_garbage_bag", name: "Bio Garbage Bag Big Size", unit: "Pcs" },
      { id: "printer_roll", name: "Printer Roll", unit: "Pcs" },
      { id: "bio_spoon", name: "Bio Spoon", unit: "Pcs" },
      { id: "wooden_plates", name: "Wooden Plates", unit: "Pcs" },
      { id: "paper_bowl", name: "Paper Bowl", unit: "Pcs" },
      { id: "filter_coffee_glass", name: "Filter Coffee Glass", unit: "Pcs" },
      { id: "chhachh_glass", name: "Masala Chhachh Glass", unit: "Pcs" },
      { id: "filter_coffee_pkg", name: "Filter Coffee Packaging", unit: "Pcs" },
      { id: "chhachh_pkg", name: "Masala Chhachh Packaging", unit: "Pcs" },
      { id: "stirrer", name: "Stirrer", unit: "Pcs" },
      { id: "clean_wrap", name: "Clean Wrap", unit: "Pcs" },
      { id: "tissues", name: "Tissues", unit: "Pcs" },
      { id: "chef_cap", name: "Chef Cap", unit: "Pcs" },
      { id: "butter_paper", name: "Butter Paper", unit: "Pcs" },
      { id: "tape", name: "Tape", unit: "Pcs" },
      { id: "hand_gloves", name: "Hand Gloves", unit: "Pcs" },
      { id: "kitchen_wipes", name: "Kitchen Wipes", unit: "Pcs" },
      { id: "rasam_glass", name: "Rasam Glass", unit: "Pcs" },
    ]},
