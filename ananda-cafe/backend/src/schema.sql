...
-- ═══════════════════════════════════════════════════════════════
--  DAILY REVIEW SUMMARY — 2026-07 migration
--  Per outlet/platform (Zomato/Swiggy) rating summary, sourced from PetPooja
--  CRM > Feedback > Ratings & Reviews + Reports > Order Report: Sub-Order
--  Wise. One row per (date, outlet_id, platform). Owner's Reviews tab reads
--  this; populated by an external daily scrape (or manual backfill) via
--  POST /api/petpooja/reviews/daily.
-- ═══════════════════════════════════════════════════════════════
